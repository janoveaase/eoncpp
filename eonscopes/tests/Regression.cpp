...
namespace eon
{
	TEST( GlobalTest, cache )
	{
		...
		REQUIRE_TRUE( l->at( name_test ).type().isName( name_string ) );
		...
		REQUIRE_TRUE( s->at( name_test ).type().isName( name_string ) );
		...
		REQUIRE_TRUE( p->at( name_test ).type().isName( name_string ) );
		...
		REQUIRE_TRUE( r->at( name_test ).type().isName( name_string ) );
		...
		REQUIRE_TRUE( o->at( name_test ).type().isName( name_string ) );
