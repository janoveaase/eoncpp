...
namespace eon
{
	...
	**************************************************************************/
	...
	{
		/**********************************************************************
		  Eon Type Specification Class - eon::tup::typespec

		  Base type specification for all objects
		**********************************************************************/
		class typespec
		{
		public:
			...
			inline bool isType() const noexcept { return Main == maintype::type; }
			inline bool isIntance() const noexcept { return Main == maintype::instance; }
			inline bool isAction() const noexcept { return Main == maintype::action; }
			inline bool isShared() const noexcept { return Main == maintype::shared; }
			virtual bool is( name_t name ) const noexcept { return false; }
