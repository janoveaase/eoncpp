...
namespace eon
{
	...
	namespace actions
	{
		...
		**********************************************************************/
		...
		{
		public:
			inline IntCopyConstruct() : Action( name_int, Type::instance, name_construct, name_int, DynamicTuple( {
		...
		{
		public:
			inline IntBoolConstruct() : Action( name_int, Type::instance, name_construct, name_int, DynamicTuple( {
		...
		{
		public:
			inline IntByteConstruct() : Action( name_int, Type::instance, name_construct, name_int, DynamicTuple( {
		...
		{
		public:
			inline IntCharConstruct() : Action( name_int, Type::instance, name_construct, name_int, DynamicTuple( {
		...
		{
		public:
			inline IntShortConstruct() : Action( name_int, Type::instance, name_construct, name_int, DynamicTuple( {
		...
		{
		public:
			inline IntLongConstruct() : Action( name_int, Type::instance, name_construct, name_int, DynamicTuple( {
		...
		{
		public:
			inline IntFloatConstruct() : Action( name_int, Type::instance, name_construct, name_int, DynamicTuple( {
		...
		{
		public:
			inline IntLowConstruct() : Action( name_int, Type::instance, name_construct, name_int, DynamicTuple( {
		...
		{
		public:
			inline IntHighConstruct() : Action( name_int, Type::instance, name_construct, name_int, DynamicTuple( {
		...
		{
		public:
			inline IntIndexConstruct() : Action( name_int, Type::instance, name_construct, name_int, DynamicTuple( {
		...
		{
		public:
			inline IntCmp() : Action( name_int, opcode::cmp, name_int, DynamicTuple( {
		...
		{
		public:
			inline IntPlus() : Action( name_int, opcode::plus, name_int, DynamicTuple( {
				type::Attribute( name_other, name_int ) } ) ) {}
		...
		{
		public:
			inline IntMinus() : Action( name_int, opcode::minus, name_int, DynamicTuple( {
				type::Attribute( name_other, name_int ) } ) ) {}
		...
		{
		public:
			inline IntMultiply() : Action( name_int, opcode::multiply, name_int, DynamicTuple( {
				type::Attribute( name_other, name_int ) } ) ) {}
		...
		{
		public:
			inline IntDivide() : Action( name_int, opcode::divide, name_int, DynamicTuple( {
				type::Attribute( name_other, name_int ) } ) ) {}
		...
		{
		public:
			inline IntElementIndex() : Action( name_int, opcode::element, name_int, DynamicTuple( {
		...
		{
		public:
			inline IntElementInt() : Action( name_int, opcode::element, name_int, DynamicTuple( {
		...
		{
		public:
			inline IntSlice() : Action( name_int, opcode::slice, name_int, DynamicTuple( {
		...
		{
		public:
			inline IntBitAnd() : Action( name_int, opcode::bit_and, name_int, DynamicTuple( {
				type::Attribute( name_other, name_int ) } ) ) {}
		...
		{
		public:
			inline IntBitOr() : Action( name_int, opcode::bit_or, name_int, DynamicTuple( {
				type::Attribute( name_other, name_int ) } ) ) {}
		...
		{
		public:
			inline IntBitXor() : Action( name_int, opcode::bit_xor, name_int, DynamicTuple( {
				type::Attribute( name_other, name_int ) } ) ) {}
		...
		{
		public:
			inline IntLShift() : Action( name_int, opcode::bit_lsh, name_int, DynamicTuple( {
		...
		{
		public:
			inline IntRShift() : Action( name_int, opcode::bit_rsh, name_int, DynamicTuple( {
				type::Attribute( name_other, name_index ) } ) ) {}
