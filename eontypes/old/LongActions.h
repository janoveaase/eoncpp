...
namespace eon
{
	...
	namespace actions
	{
		...
		**********************************************************************/
		...
		{
		public:
			inline LongCopyConstruct() : Action( name_long, Type::instance, name_construct, name_long, DynamicTuple( {
		...
		{
		public:
			inline LongBoolConstruct() : Action( name_long, Type::instance, name_construct, name_long, DynamicTuple( {
		...
		{
		public:
			inline LongByteConstruct() : Action( name_long, Type::instance, name_construct, name_long, DynamicTuple( {
		...
		{
		public:
			inline LongCharConstruct() : Action( name_long, Type::instance, name_construct, name_long, DynamicTuple( {
		...
		{
		public:
			inline LongShortConstruct() : Action( name_long, Type::instance, name_construct, name_long, DynamicTuple( {
		...
		{
		public:
			inline LongIntConstruct() : Action( name_long, Type::instance, name_construct, name_long, DynamicTuple( {
		...
		{
		public:
			inline LongFloatConstruct() : Action( name_long, Type::instance, name_construct, name_long, DynamicTuple( {
		...
		{
		public:
			inline LongLowConstruct() : Action( name_long, Type::instance, name_construct, name_long, DynamicTuple( {
		...
		{
		public:
			inline LongHighConstruct() : Action( name_long, Type::instance, name_construct, name_long, DynamicTuple( {
		...
		{
		public:
			inline LongIndexConstruct() : Action( name_long, Type::instance, name_construct, name_long, DynamicTuple( {
		...
		{
		public:
			inline LongCmp() : Action( name_long, opcode::cmp, name_int, DynamicTuple( {
		...
		{
		public:
			inline LongPlus() : Action( name_long, opcode::plus, name_long, DynamicTuple( {
				type::Attribute( name_other, name_long ) } ) ) {}
		...
		{
		public:
			inline LongMinus() : Action( name_long, opcode::minus, name_long, DynamicTuple( {
				type::Attribute( name_other, name_long ) } ) ) {}
		...
		{
		public:
			inline LongMultiply() : Action( name_long, opcode::multiply, name_long, DynamicTuple( {
				type::Attribute( name_other, name_long ) } ) ) {}
		...
		{
		public:
			inline LongDivide() : Action( name_long, opcode::divide, name_long, DynamicTuple( {
				type::Attribute( name_other, name_long ) } ) ) {}
		...
		{
		public:
			inline LongElementIndex() : Action( name_long, opcode::element, name_long, DynamicTuple( {
		...
		{
		public:
			inline LongElementInt() : Action( name_long, opcode::element, name_long, DynamicTuple( {
		...
		{
		public:
			inline LongSlice() : Action( name_long, opcode::slice, name_long, DynamicTuple( {
				type::Attribute( name::get( "first" ), name_int ), type::Attribute( name::get( "last" ), name_int ) } ) ) {}
		...
		{
		public:
			inline LongBitAnd() : Action( name_long, opcode::bit_and, name_long, DynamicTuple( {
				type::Attribute( name_other, name_long ) } ) ) {}
		...
		{
		public:
			inline LongBitOr() : Action( name_long, opcode::bit_or, name_long, DynamicTuple( {
				type::Attribute( name_other, name_long ) } ) ) {}
		...
		{
		public:
			inline LongBitXor() : Action( name_long, opcode::bit_xor, name_long, DynamicTuple( {
				type::Attribute( name_other, name_long ) } ) ) {}
		...
		{
		public:
			inline LongLShift() : Action( name_long, opcode::bit_lsh, name_long, DynamicTuple( {
		...
		{
		public:
			inline LongRShift() : Action( name_long, opcode::bit_rsh, name_long, DynamicTuple( {
				type::Attribute( name_other, name_index ) } ) ) {}
