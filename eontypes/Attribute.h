	...
	namespace type
	{
		...
		**********************************************************************/
		enum class Qualifier : uint8_t
		{
			...
			syntax,			//* Value is a name reference

//			no_value = 0x10	//* Value is given as "..."
		};
		...
		**********************************************************************/
		...
		public:
			...
			inline Attribute( name_t name, MetaData* meta, Object* value = nullptr ) {
				Name = name; Meta = meta; if( value ) Type = value->type(); assign( value ); }
			...
			inline Attribute( name_t name, const TypeTuple& type, MetaData* meta, Object* value = nullptr ) {
				Name = name; Type = type; Meta = meta; assign( value ); }
			inline Attribute( name_t name, name_t type, MetaData* meta, Object* value = nullptr ) {
				Name = name; Type = TypeTuple( { type } ); Meta = meta; assign( value ); }
			...
			inline Attribute( name_t name, MetaData* meta, Qualifier qual, Object* value = nullptr ) {
				Name = name; Meta = meta; Qual = qual; if( value ) Type = value->type(); assign( value ); }
			...
			inline Attribute( name_t name, const TypeTuple& type, MetaData* meta, Qualifier qual, Object* value = nullptr ) {
				Name = name; Type = type; Meta = meta; Qual = qual; assign( value ); }
			inline Attribute( name_t name, name_t type, MetaData* meta, Qualifier qual, Object* value = nullptr ) {
				Name = name; Type = TypeTuple( { type } ); Meta = meta; Qual = qual; assign( value ); }


			inline Qualifier qualifier() const noexcept { return Qual; }
			inline name_t name() const noexcept { return Name; }
			inline MetaData* meta() const noexcept { return Meta; }
