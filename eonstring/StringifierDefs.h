...
namespace eon::stringify
{
	...
	{
		Element() = default;
		inline explicit Element( Type type ) noexcept : ElmType( type ) {}
		...
		inline bool isSplitBlock() const noexcept {
			return ElmType == Type::prim_split_block
	...
	struct Line
	{
		...
		inline void push_back( const Element& element ) {
